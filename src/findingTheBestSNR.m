...
figureData = [figureData ,round(BER_prediction2',10) ];
semilogy(SNR,BER_prediction2)
hold on;
end
figureData = [SNR', figureData]
title("Graph showing BER performance when trained on a specific SNR");
xlabel("SNR (dB)");
ylabel("Bit Error Rate (BER)");
legend("1 dB","2 dB","4 dB","8 dB","10 dB","12 dB","16 dB","20 dB")
% iii = [1,2,4,8,10,12,16,20];
% figureData
BER_prediction2'
